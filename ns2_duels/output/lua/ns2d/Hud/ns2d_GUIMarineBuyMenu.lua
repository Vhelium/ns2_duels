...
function ns2d_GUIMarineBuyMenu:_InitializeUpgradeButtons()
    ...
    self.menu:SetTexturePixelCoordinates(0, 0, ns2d_GUIMarineBuyMenu.kMenuWidth, ns2d_GUIMarineBuyMenu.kBackgroundHeight)
    ...
    self.menuHeader:SetTexturePixelCoordinates(0, 0, ns2d_GUIMarineBuyMenu.kMenuWidth, ns2d_GUIMarineBuyMenu.kResourceDisplayHeight)
